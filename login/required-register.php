...
<header id="backbtnheader">
        <a href="http://localhost/fyp/interactive.php"><i class="fa fa-arrow-left" style="font-size:36px" id="backbtn"></i></a>
    </header>

    <div class="container">
        <div class="box form-box">
            <header>Please sign up to use the features</header>
            <p>Note: We just want to save your score!</p><br><br>
