...
<body id="top">
  <main>
    ...
    <!-- table -->
    <div id="tableSection">
    <h1 id="texttitle">List of Feedback</h1><br>
            ...
            while ($row = $result->fetch_assoc()) {
              echo "
                      <tr>
                          <td>$row[name]</td>
                          <td>$row[email]</td>
                          <td>$row[feedbackmsg]</td>
                          <td>$row[datepost]</td>
                          <td>
                          <a class='buttonedit' href='edit.php?id=$row[id]'>Edit</a>
                          <a class='buttondelete' href='delete.php?id=$row[id]'>Delete</a>
